...
Original file is located at
    https://colab.research.google.com/drive/1J4x06OFbbl_iW7keH3zBQSCY20fxYUvH
"""
...
top_5_customers=df.groupby('Customer Name')['Sales'].sum()[:5].sort_values(ascending= False)
...
sales_by_month= df.groupby('Month')['Sales'].sum().sort_values(ascending=False)[:1]
